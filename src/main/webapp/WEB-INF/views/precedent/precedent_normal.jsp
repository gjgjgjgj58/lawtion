...
$(document).ready(function(){
	...
	$("#search").click(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "http://localhost:9000/lawtion/precedent_normal.do?rpage="+e.page);         
	    });
...
<body>
	...
	<form name="searchform" action="search_input.do" method="post">
		...
		<table class="table1">	
				...
				<td rowspan="11" class="category">
					    ...
					    <ul class="tree"> 
					        <li>
					            ...
					            <ul class="tree">
					                <li><a href="tree_cate.do?category=1&wpage=normal">└민사</a></li>
					                <li><a href="tree_cate.do?category=2&wpage=normal">└형사</a></li>
					                <li><a href="tree_cate.do?category=3&wpage=normal">└가사</a></li>
					                <li><a href="tree_cate.do?category=4&wpage=normal">└특허</a></li>
					                <li><a href="tree_cate.do?category=5&wpage=normal">└세무</a></li>
					                <li><a href="tree_cate.do?category=6&wpage=normal">└일반행정</a></li>
					            </ul>
					        </li>
					     </ul>
					     ...
					     <ul class="tree"> 
					        <li>
					            ...
					            <ul class="tree">
					                <li><a href="tree_scale.do?scale=1&wpage=normal">└대법원</a></li>
					                <li><a href="tree_scale.do?scale=2&wpage=normal">└고등법원</a></li>
					                <li><a href="tree_scale.do?scale=3&wpage=normal">└하급심</a></li>
					            </ul>
					        </li>
					     </ul>
					     ...
					     <ul class="tree">
					        <li>
					            ...
					            <ul class="tree">
					                <li><a href="tree_result.do?result=1&wpage=normal">└승소</a></li>
					                <li><a href="tree_result.do?result=2&wpage=normal">└패소</a></li>
					            </ul>
					        </li>
					    </ul>
					    </li>
			...
			<tr>
				<td>${vo.rno }</td>
				<td><a href="http://localhost:9000/lawtion/precedent_content.do?no=${vo.no }&rno=${vo.rno}">
					${vo.title }
				</a></td>
				<td>${vo.result }</td>
				<td>${vo.hits }</td>
